module.exports = async function (context, req) {
  ...
  if (req.query.condition) { pacientsMatchOperators.$match.condition = req.query.condition; }
  if (req.query.sex) { pacientsMatchOperators.$match.sex = req.query.sex; }
  ...
  if (req.query.maxSessions) { maxSessions = req.query.maxSessions; }

  if (req.query.phase) { plataformMathOperators.$match.phase = req.query.phase; }
  if (req.query.level) { plataformMathOperators.$match.level = req.query.level; }

  if (req.query.devices) { deviceName = req.query.devices; }
  ...
  try {
    ...
    const plataformInfos = await PlataformOverviewModel.find({ pacientId: { $in: plataformStatisticsPacientsIds } }, {
