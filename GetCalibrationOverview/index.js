...
module.exports = async function (context, req) {
  context.log.info(`[GetCalibrationOverview] Function has been called! - ${context.invocationId}`);
  ...
  try {
    ...
    context.log.info('Getting CalibrationOverview Results...');

    const results = (
      await calibrationOverviewService
        .getCalibrationOverview(req.query, req.headers['game-token'])
    );
